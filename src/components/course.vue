  ...
  <v-container class="course">
    ...
    <v-row>
      <v-col  md="6">
        <v-card class="pa-2" style="border:none;" outlined tile>
          <v-card class="mx-auto" height="50%">
            <v-img src="@/image/1.png" height="250px"></v-img>
      ...
      <v-col  md="6">
        <v-card class="pa-2" style="border:none;" outlined tile>
          <v-card class="mx-auto" height="50%">
            <v-img src="@/image/2.png" height="250px"></v-img>
      ...
      <v-col  md="6">
        <v-card class="pa-2" style="border:none;" outlined tile>
          <v-card class="mx-auto" height="50%">
            <v-img src="@/image/3.png" height="250px"></v-img>
      ...
      <v-col  md="6">
        <v-card class="pa-2" style="border:none;" outlined tile>
          <v-card class="mx-auto" height="50%">
            <v-img src="@/image/4.png" height="250px"></v-img>
